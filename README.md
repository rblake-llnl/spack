...
A small number of package.py files (< 37 out of over 2,800) are still
only available under LGPL-2.1 terms.  They will eventually be relicensed,
rewritten, or removed as we work towards 100% Apache2/MIT.  To see which
package files are still under the LGPL-2.1 license, run the `spack
license list-lgpl` command.
